...
<div class="max-w-4xl mx-auto">
    ...
    <div class="bg-white p-8 rounded-lg shadow-sm">
        ...
        <?php
        // Lọc chỉ lấy những tin nhắn mà người dùng hiện tại được phép xem
        $visibleMessages = array_filter($messages ?? [], function ($msg) use ($isOwnProfile, $currentUserId) {
            return $isOwnProfile || $currentUserId == $msg['sender_id'];
        });
        ?>
        <div>
            <h3 class="text-xl font-bold text-gray-700 mb-4">(<?= count($visibleMessages) ?> tin nhắn)</h3>
